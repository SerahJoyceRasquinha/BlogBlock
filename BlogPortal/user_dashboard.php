...
// --- FETCH TOTAL POSTS FOR THIS USER ---
$stmt = $conn->prepare("SELECT COUNT(*) FROM user_blog_posts WHERE username = ?");
...
<div class="dashboard-wrapper">
    ...
    <div class="main-container">
        ...
        <div class="sidebar">
            ...
            <button class="sidebar-btn post-btn" onclick="window.location.href='blog_history.php'">
                View Blog History
            </button>
